...
AS
	SELECT CAST(NULL AS DATETIMEOFFSET(7)) AS LOAD_DTS,
		...
		CONVERT(CHAR(32), HASHBYTES('MD5', ISNULL(TRIM(CONVERT(NVARCHAR(50), [ORDERID])), N'') + N'W|D'), 2) AS HK,
		CONVERT(
			CHAR(32),
			HASHBYTES(
				'MD5',
				+ ISNULL(TRIM(CONVERT(NVARCHAR(255), [ORDERDATE])), N'') + N'W|D'
				+ ISNULL(TRIM(CONVERT(NVARCHAR(255), [GAMEID])), N'') + N'W|D'
		...
		CONVERT(
			...
			HASHBYTES(
				'MD5',
				ISNULL(TRIM(CONVERT(NVARCHAR(255), [ORDERID])), N'') + N'W|D'
				+ ISNULL(TRIM(CONVERT(NVARCHAR(255), [ORDERDATE])), N'') + N'W|D'
				+ ISNULL(TRIM(CONVERT(NVARCHAR(255), [GAMEID])), N'') + N'W|D'
				+ ISNULL(TRIM(CONVERT(NVARCHAR(255), [CUSTOMERID])), N'') + N'W|D'
				),
