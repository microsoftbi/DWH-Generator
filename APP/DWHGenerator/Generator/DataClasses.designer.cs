...
namespace Generator
{
	...
	public partial class V_ATTRIBUTE
	{
		...
		private string _L_DATA_TYPE;
		
		private System.Nullable<int> _L_CHARACTER_MAXIMUM_LENGTH;
		
		private System.Nullable<byte> _L_NUMERIC_PRECISION;
		
		private System.Nullable<int> _L_NUMERIC_SCALE;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_L_DATA_TYPE", DbType="NVarChar(128)")]
		public string L_DATA_TYPE
		{
			get
			{
				return this._L_DATA_TYPE;
			}
			set
			{
				if ((this._L_DATA_TYPE != value))
				{
					this._L_DATA_TYPE = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_L_CHARACTER_MAXIMUM_LENGTH", DbType="Int")]
		public System.Nullable<int> L_CHARACTER_MAXIMUM_LENGTH
		{
			get
			{
				return this._L_CHARACTER_MAXIMUM_LENGTH;
			}
			set
			{
				if ((this._L_CHARACTER_MAXIMUM_LENGTH != value))
				{
					this._L_CHARACTER_MAXIMUM_LENGTH = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_L_NUMERIC_PRECISION", DbType="TinyInt")]
		public System.Nullable<byte> L_NUMERIC_PRECISION
		{
			get
			{
				return this._L_NUMERIC_PRECISION;
			}
			set
			{
				if ((this._L_NUMERIC_PRECISION != value))
				{
					this._L_NUMERIC_PRECISION = value;
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_L_NUMERIC_SCALE", DbType="Int")]
		public System.Nullable<int> L_NUMERIC_SCALE
		{
			get
			{
				return this._L_NUMERIC_SCALE;
			}
			set
			{
				if ((this._L_NUMERIC_SCALE != value))
				{
					this._L_NUMERIC_SCALE = value;
				}
			}
		}
