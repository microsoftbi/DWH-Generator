...
CREATE TABLE [gs].[CUSTOMER](
	...
	[FULLY_QUALIFIED_FILE_NAME] [nvarchar](20) NULL,
...
ALTER TABLE [gs].[CUSTOMER] ADD  CONSTRAINT [DF_CUSTOMER_FILE_TRANSFER_DTS]  DEFAULT (getdate()) FOR [FILE_TRANSFER_DTS]
GO

ALTER TABLE [gs].[CUSTOMER] ADD  CONSTRAINT [DF_CUSTOMER_FULLY_QUALIFIED_FILE_NAME]  DEFAULT ('gs.GAME') FOR [FULLY_QUALIFIED_FILE_NAME]
GO
...
CREATE TABLE [gs].[GAMELIST](
	[Fully_Qualified_File_Name] [varchar](25) NOT NULL,
	[FILE_TRANSFER_DTS] [datetimeoffset](7) NOT NULL,
...
ALTER TABLE [gs].[GAMELIST] ADD  CONSTRAINT [DF_GAMELIST_Fully_Qualified_File_Name]  DEFAULT ('gs.GAME') FOR [Fully_Qualified_File_Name]
GO

ALTER TABLE [gs].[GAMELIST] ADD  CONSTRAINT [DF_GAMELIST_FILE_TRANSFER_DTS]  DEFAULT (getdate()) FOR [FILE_TRANSFER_DTS]
GO
...
CREATE TABLE [gs].[ORDER](
	...
	[FILE_TRANSFER_DTS] [datetimeoffset](7) NULL,
	[FULLY_QUALIFIED_FILE_NAME] [nvarchar](20) NULL,
	[RECORD_SOURCE] [nvarchar](15) NULL
) ON [PRIMARY]
GO
...
ALTER TABLE [gs].[ORDER] ADD  CONSTRAINT [DF_ORDER_FILE_TRANSFER_DTS]  DEFAULT (getdate()) FOR [FILE_TRANSFER_DTS]
GO

ALTER TABLE [gs].[ORDER] ADD  CONSTRAINT [DF_ORDER_FULLY_QUALIFIED_FILE_NAME]  DEFAULT (N'gs.ORDER') FOR [FULLY_QUALIFIED_FILE_NAME]
GO

ALTER TABLE [gs].[ORDER] ADD  CONSTRAINT [DF_ORDER_RECORD_SOURCE]  DEFAULT ('GS') FOR [RECORD_SOURCE]
GO
